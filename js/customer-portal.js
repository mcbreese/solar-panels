...
function returnData(customerID) {
    ...
    try {
        ...
        $(".main-body").html("<div style='margin-left:20px;'>" + "<h1>SOLAR CONFIGURATIONS</h1>" + "<p>No potential solar panel system have been configured for your home yet.</p>" + "<p>Please return to this page later.</p>");
    }
}
...
function addOptionsToPage(customerData, budget) {
    ...
    for (i = 0; i < customerData.length; i++) {
        ...
        output =
            "<div class='options'><h3>Option " +
            (i + 1) +
            "</h3>" +
            budgetHTML +
            "<p>1. Total expected power generation on the solstices at noon: " +
            customerData[i][0] +
            "W (summer)\t " +
            customerData[i][1] +
            "W (winter)</p>" +
            "<p>2. Total installation cost of this option : £" +
            customerData[i][2] +
            "</p>" +
            "<p>3. Total cost per watt as this rate : £/W " +
            customerData[i][3] +
            "W (summer)\t " +
            customerData[i][4] +
            "W (winter)</p>" +
            "<p>4. Hours battery will be more than 75% discharged:</p><p style='text-indent:10px'>  Summer: " +
            dischargeSummer +
            " </p><p style='text-indent:10px'>  Winter: " +
            dischargeWinter +
            "</p>" +
